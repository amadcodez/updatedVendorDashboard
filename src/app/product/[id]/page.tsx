      ...
      <div className="max-w-7xl mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div>
          ...
          <div className="flex items-center gap-4 mb-4">
            <span className="text-3xl font-bold text-pink-600">${product.itemPrice}</span>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-6">
            <button className="bg-pink-600 hover:bg-pink-700 text-white font-semibold py-3 px-6 rounded shadow">
              Add to Cart
            </button>
            <button className="border border-pink-600 text-pink-600 hover:bg-pink-50 font-semibold py-3 px-6 rounded shadow">
              Buy Now
            </button>
          </div>
          ...
          {relatedProducts.map((item: any) => (
            <Link key={item._id} href={`/product/${item._id}`}>
              <div className="border rounded-lg p-4 shadow hover:shadow-md transition">
                ...
                <p className="text-pink-600 font-bold mt-1">${item.itemPrice}</p>
              </div>
            </Link>
          ))}
        </div>
